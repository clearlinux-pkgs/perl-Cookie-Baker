...
%prep
%setup -q -n Cookie-Baker-0.12
cd %{_builddir}/Cookie-Baker-0.12
pushd ..
cp -a Cookie-Baker-0.12 buildavx2
popd
pushd ..
cp -a Cookie-Baker-0.12 buildapx
popd
...
cp %{_builddir}/Cookie-Baker-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Cookie-Baker/3974dccbc4afd3a0f00ad1f2d510bbf5d862bda7 || :
if test -f Makefile.PL; then
